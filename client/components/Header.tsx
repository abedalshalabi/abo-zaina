    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container mx-auto px-3 sm:px-4 py-2">
          <div className="flex items-center justify-between text-xs sm:text-sm">
            <div className="flex items-center gap-2 sm:gap-4 text-gray-600">
              <span className="text-xs sm:text-sm">📞 966+ 11 456 7890</span>
              <span className="hidden sm:inline text-xs sm:text-sm">✉️ info@abu-zaina.com</span>
            </div>
            <div className="text-gray-600 text-xs sm:text-sm hidden xs:block">
              مرحباً بكم في أبو زينة للتقنيات
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
              ...
              <Link to="/" className="flex items-center gap-2 sm:gap-4">
                ...
                <div className="hidden md:block">
                  <h1 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">
                    {title || "أبو زينة للتقنيات"}
                  </h1>
                  <p className="text-xs sm:text-sm text-blue-600">
                    {subtitle || "عالم التكنولوجيا والأجهزة الكهربائية"}
                  </p>
                </div>
              </Link>
            </div>
          ...
          {/* Search Bar */}
          {showSearch && (
            <div className="flex-1 max-w-xl mx-1 sm:mx-2 md:mx-4 lg:mx-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Link to="/" className="block text-gray-600 hover:text-blue-600 transition-colors">الرئيسية</Link>
                  <Link to="/products" className="block text-gray-600 hover:text-blue-600 transition-colors">المنتجات</Link>
                  <Link to="/offers" className="block text-gray-600 hover:text-blue-600 transition-colors">العروض</Link>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Link to="/about" className="block text-gray-600 hover:text-blue-600 transition-colors">من نحن</Link>
                  <Link to="/contact" className="block text-gray-600 hover:text-blue-600 transition-colors">اتصل بنا</Link>
                  <Link to="/shipping" className="block text-gray-600 hover:text-blue-600 transition-colors">الشحن والتوصيل</Link>
                  <Link to="/returns" className="block text-gray-600 hover:text-blue-600 transition-colors">الإرجاع والاستبدال</Link>
                  <Link to="/warranty" className="block text-gray-600 hover:text-blue-600 transition-colors">الضمان</Link>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Link to="/login" className="block text-gray-600 hover:text-blue-600 transition-colors">تسجيل الدخول</Link>
                  <Link to="/register" className="block text-gray-600 hover:text-blue-600 transition-colors">إنشاء حساب</Link>
                </div>
              </div>
            </div>
          </div>
