...
const Offers = () => {
  ...
  const weeklyDeals = [
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 87,
      image: "https://www.kenwoodworld.com/Global/recipes/multimediaObject/productShotPrimary/KMX750RD_1.png",
      badge: "جودة عالية",
  ...
  const bundleOffers = [
    {
      ...
      originalPrice: 4599,
      discount: 28,
      image: "https://images.samsung.com/is/image/samsung/assets/ae/kitchen-appliances/kitchen-bundle-hero.jpg",
      savings: 1300,
      badge: "باقة حصرية"
    },
    {
