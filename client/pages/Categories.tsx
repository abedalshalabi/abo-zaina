      ...
      <div className="w-full flex flex-col items-center gap-6">
        {rows.map((row, rowIndex) => (
          ...
          >
            ...
            {rowIndex > 0 && (
              <div className="absolute left-1/2 -top-6 h-6 w-0.5 bg-blue-100" />
            )}
            {row.map((node) => {
              ...
              return (
                <div key={node.id} className="flex flex-col items-center gap-2">
                  <div className="relative flex flex-col items-center">
                    <div
                      className={`hidden md:block absolute ${connectorTopClass} ${connectorHeightClass} w-0.5 bg-blue-100`}
                    />
                    <Link
                    ...
                    >
                      {node.image ? (
                        ...
                        <span
                          className={
                            depth === 1
                              ? "text-sm font-semibold text-blue-600 text-center px-2"
                              : "text-[11px] font-semibold text-blue-600 text-center px-2 leading-tight"
                          }
                        >
                  ...
                  <Link
                    ...
                    className={
                      depth === 1
                        ? "text-xs font-medium text-gray-600 hover:text-blue-600 transition-colors text-center w-24 leading-snug"
                        : "text-[11px] font-medium text-gray-500 hover:text-blue-600 transition-colors text-center w-24 leading-tight"
                    }
                  >
                    {node.name}
                  </Link>
                  {node.children.length > 0 && (
                    <div className="mt-2 w-full flex justify-center">
                      <div className="hidden md:block w-0.5 h-4 bg-blue-100" />
                    </div>
                  )}
