        ...
        {loading ? (
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8">
            {brands.map((brand) => (
              ...
              >
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full border-2 border-blue-100 bg-white shadow-sm hover:shadow-md transition-all overflow-hidden flex items-center justify-center group-hover:border-blue-300">
                  {brand.logo ? (
                    <img
                      src={brand.logo}
                      alt={brand.name}
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 text-blue-600 text-lg md:text-xl font-bold">
                      {brand.name.charAt(0)}
                    </div>
                  )}
                </div>
                <div className="text-center">
                  <span className="text-sm md:text-base font-semibold text-gray-700 group-hover:text-blue-600 transition-colors block">
                    {brand.name}
                  </span>
