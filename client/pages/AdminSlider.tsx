...
const AdminSlider = () => {
  ...
  const handleEdit = (item: SliderItem) => {
    ...
    setFormData({
      ...
      button1_color: item.button1_color || "bg-white text-blue-900",
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      لون الخلفية (Gradient Classes) - اختياري إذا كان هناك صورة
                    </label>
                    <input
                      type="text"
                      value={formData.background_color}
                      onChange={(e) => setFormData({ ...formData, background_color: e.target.value || null })}
                      placeholder="from-blue-900 via-blue-800 to-indigo-900 (اتركه فارغاً إذا كان هناك صورة)"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      مثال: from-blue-900 via-blue-800 to-indigo-900. اتركه فارغاً إذا كنت تستخدم صورة خلفية فقط.
                    </p>
                  </div>
