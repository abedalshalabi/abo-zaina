      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="mt-8 flex gap-4 justify-center">
            <Link
              to="/"
              className="bg-blue-600 text-white px-8 py-4 rounded-full hover:bg-blue-700 transition-colors flex items-center gap-2 shadow-lg"
            >
            ...
            <Link
              to="/contact"
              className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-full hover:bg-blue-600 hover:text-white transition-colors"
            >
              تواصل معنا
            </Link>
          </div>
